...
const CLIENT_ID = "your_spotify_client_id"; // The client id for your Spotify app
const REDIRECT_URI = "http://localhost:3000/callback"; // The redirect uri for your Spotify app
